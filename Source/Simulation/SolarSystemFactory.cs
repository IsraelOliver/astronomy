...
public static class SolarSystemFactory
{
    ...
    private static IReadOnlyList<CelestialBody> CreatePlanets()
    {
        return new[]
        {
            ...
            new CelestialBody("Saturno", 295f, 10759f, 10.4f, new Color(222, 199, 145), 1.4f, 9.58f, 0.0565f, 116460, 5.6834e26, 95.2f, 10.44f, -140, 35500f, 9.68f, "Gigante gasoso famoso por seus aneis extensos.", HasRings: true),
            new CelestialBody("Urano", 365f, 30687f, 8.1f, new Color(139, 217, 220), 2.7f, 19.20f, 0.0463f, 50724, 8.6810e25, 14.5f, 8.69f, -195, 9320f, 6.80f, "Gigante gelado com eixo de rotacao muito inclinado."),
