...
public static class SolarSystemFactory
{
    ...
    private static IReadOnlyList<CelestialBody> CreatePlanets()
    {
        return new[]
        {
            new CelestialBody("Mercurio", 46f, 88f, 3.2f, new Color(184, 174, 152), 0.9f, 0.39f, 0.2056f, 4879, 3.3011e23, 0.055f, 3.7f, 167, 10.9f, 47.36f, "Menor planeta e o mais próximo do Sol."),
            ...
            new CelestialBody("Terra", 104f, 365f, 5.8f, new Color(75, 150, 232), 3.3f, 1.00f, 0.0167f, 12742, 5.9724e24, 1.00f, 9.81f, 15, 1674.4f, 29.78f, "Nosso planeta, com água líquida estável na superfície."),
            ...
            new CelestialBody("Saturno", 295f, 10759f, 10.4f, new Color(222, 199, 145), 1.4f, 9.58f, 0.0565f, 116460, 5.6834e26, 95.2f, 10.44f, -140, 35500f, 9.68f, "Gigante gasoso famoso por seus anéis extensos.", HasRings: true, RingStyle: "Saturn"),
            new CelestialBody("Urano", 365f, 30687f, 8.1f, new Color(139, 217, 220), 2.7f, 19.20f, 0.0463f, 50724, 8.6810e25, 14.5f, 8.69f, -195, 9320f, 6.80f, "Gigante gelado com eixo de rotação muito inclinado e anéis estreitos, escuros e difíceis de observar.", HasRings: true, RingStyle: "Uranus"),
            ...
            new CelestialBody("Plutao", 565f, 90560f, 2.7f, new Color(190, 158, 132), 5.9f, 39.48f, 0.2488f, 2376, 1.303e22, 0.00218f, 0.62f, -229, 48.7f, 4.74f, "Planeta anão distante, com órbita muito elíptica e inclinada em relação aos planetas principais.", OrbitArgumentDegrees: 108f, OrbitPlaneTiltDegrees: 18f)
        };
    }
